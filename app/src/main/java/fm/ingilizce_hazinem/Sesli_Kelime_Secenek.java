 ...
 */
public class Sesli_Kelime_Secenek extends Fragment {

    RelativeLayout relativeLayout;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.sesli_kelime_secenek,container,false);
        relativeLayout= (RelativeLayout) view.findViewById(R.id.relative);
        relativeLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(Kleime_Bulma_Secenek.kelimelis.size()>6) {
                    Intent in=new Intent(getActivity(),Sesli_Kelime.class);
                    startActivity(in);
                    deneme.tiklanan=3;
                }else
