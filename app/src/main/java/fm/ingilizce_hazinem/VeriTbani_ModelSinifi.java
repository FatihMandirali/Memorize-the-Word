 ...
 */
public class VeriTbani_ModelSinifi extends SQLiteOpenHelper {
    ...
    public VeriTbani_ModelSinifi(Context context) {
        super(context, DATABASE_NAME, null, DATABASE_VERSION);
    }

    public VeriTbani_ModelSinifi(Kelime_Bulma kelime_bulmaClass) {
        super(kelime_bulmaClass,DATABASE_NAME,null,DATABASE_VERSION);
    }
    ...
    public long KayitEkle(Kelimeler_ModelSinifi kelimeler) {
    ...
    public List<Kelimeler_ModelSinifi> TumKayitlar() {
        ...
        for(c.moveToFirst();!c.isAfterLast();c.moveToNext()){
            Kelimeler_ModelSinifi kelime=new Kelimeler_ModelSinifi();
    ...
    public List<Kelimeler_ModelSinifi> TumKayitlar(String hangidil) {
        SQLiteDatabase db=this.getReadableDatabase();
        String []sutunlar=new String[]{Dil,Kelime,Anlami,ID};
        Cursor c1=db.query(TABLE_NAME,sutunlar,null,null,null,null,ID+" desc");
